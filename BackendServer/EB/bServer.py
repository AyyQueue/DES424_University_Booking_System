...
dbconfig = {
    "host": os.environ.get("DB_HOST", "database-1.cluster-c92q2cu240ol.us-east-1.rds.amazonaws.com"),
    "user": os.environ.get("DB_USER", "admin"),
    "password": os.environ.get("DB_PASSWORD", "admin123"),
    "database": os.environ.get("DB_NAME", "RoomBookingDB"),
...
# CORS(
#     app,
#     resources={r"/*": {"origins": "http://university-room-booking-frontend.s3-website-us-east-1.amazonaws.com"}},
#     supports_credentials=True,
#     automatic_options=True 
# )
CORS(app, supports_credentials=True)  # Allow everything
